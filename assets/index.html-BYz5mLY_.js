import{_ as i,c as a,a as n,o as l}from"./app-BfuXjANd.js";const e="/work-blog-website/assets/image-20250418164547083-BPVy4SSz.png",p="/work-blog-website/assets/image-20250418164846737-CBkG9ugt.png",h={};function k(t,s){return l(),a("div",null,[...s[0]||(s[0]=[n(`<h2 id="_1-全面概述" tabindex="-1"><a class="header-anchor" href="#_1-全面概述"><span>1.全面概述</span></a></h2><p><a href="https://nacos.io/" target="_blank" rel="noopener noreferrer">Nacos</a> 是 <code>Dynamic Naming and Configuration Service</code> 的首字母简称，一个更易于构建云原生应用的动态服务发现、配置管理和服务管理平台。它提供了一组简单易用的特性集，帮助我们快速实现动态服务发现、服务配置、服务元数据及流量管理。实际上，<code>Nacos</code> 不仅支持配置管理，它还支持服务发现（作为注册中心），以下是官网总结的 <code>Nacos</code> 地图，而本文档只使用它的配置管理功能。</p><h2 id="_2-基本功能" tabindex="-1"><a class="header-anchor" href="#_2-基本功能"><span>2.基本功能</span></a></h2><p>要学会 <code>Nacos</code> 配置管理，就先要知道几个核心概念：</p><ul><li><strong>Namespace</strong> 命名空间：命名空间用于隔离不同的配置集。它允许在同一个 <code>Nacos</code> 集群中将不同的环境（如开发、测试、生产）或者不同的业务线的配置进行隔离（默认提供了一个 <code>public</code> 命名空间）。在多租户系统中，或者需要区分不同的环境时，可以使用命名空间。例如，开发环境的配置和生产环境的配置完全隔离，可以通过不同的命名空间来管理。</li><li><strong>Group</strong> 组：配置组是用于将多个相关的配置项进行分类管理的逻辑分组机制。每个配置项可以属于不同的组，以便于配置管理。 当一个应用有多个模块，且不同模块之间共享部分配置时，可以用组来对这些模块的配置进行分类和管理。例如，一个系统中的“支付服务”和“订单服务”可能需要用不同的组来存储各自的配置。</li><li><strong>Data ID</strong> 标识：<code>Data ID</code> 是一个唯一的配置标识符，通常与具体的应用程序相关。通过 <code>Data ID</code>，<code>Nacos</code> 知道如何获取特定应用的某个具体配置。 每个应用的配置都会有一个独特的 <code>Data ID</code>。例如，一个支付系统可能有一个配置文件叫 <code>com.payment.pay-service.yaml</code>，这就是它的 <code>Data ID</code>。</li><li><strong>Config Listener</strong> 配置监听器：配置监听器用于让客户端实时监听 <code>Nacos</code> 配置中心中的配置变化，可以自动感知配置的更新并做出相应的处理。在需要动态调整配置的场景下使用，例如调整缓存大小、切换不同的服务端点等，应用可以通过监听器及时感知这些变化并应用新的配置。</li></ul><h2 id="_3-使用教程" tabindex="-1"><a class="header-anchor" href="#_3-使用教程"><span>3.使用教程</span></a></h2><h5 id="_3-1-组件部署" tabindex="-1"><a class="header-anchor" href="#_3-1-组件部署"><span>3.1.组件部署</span></a></h5><p>推送配置的方法一般有以下方式：</p><ul><li><code>Nacos</code> 控制台</li><li><a href="https://nacos.io/zh-cn/docs/quick-start-spring-boot.html" target="_blank" rel="noopener noreferrer">应用程序 SDK</a></li><li><a href="https://nacos.io/zh-cn/docs/open-api.html" target="_blank" rel="noopener noreferrer">Open API</a></li></ul><p>而监听方法一般是使用 <code>SDK</code> 配置 <a href="https://nacos.io/zh-cn/docs/sdk.html" target="_blank" rel="noopener noreferrer">Config Listener</a> 。</p><div class="language-java line-numbers-mode" data-highlighter="shiki" data-ext="java" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-java"><span class="line"><span style="--shiki-light:#393A34;--shiki-dark:#DBD7CAEE;">String</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;"> serverAddr</span><span style="--shiki-light:#999999;--shiki-dark:#666666;"> =</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77;"> &quot;</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D;">{serverAddr}</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77;">&quot;</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">;</span></span>
...
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">    }</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>待补充...</p><h2 id="_4-深入学习" tabindex="-1"><a class="header-anchor" href="#_4-深入学习"><span>4.深入学习</span></a></h2><p>待补充...</p>`,35)])])}const r=i(h,[["render",k]]),c=JSON.parse('{"path":"/5.%E5%BC%80%E5%8F%91%E6%96%B9%E5%90%91/or433c5h/","title":"注册框架 | 学习集合","lang":"zh-CN","frontmatter":{"createTime":"2025/12/29 21:53:28","permalink":"/5.开发方向/or433c5h/","title":"注册框架","description":"1.全面概述 Nacos 是 Dynamic Naming and Configuration Service 的首字母简称，一个更易于构建云原生应用的动态服务发现、配置管理和服务管理平台。它提供了一组简单易用的特性集，帮助我们快速实现动态服务发现、服务配置、服务元数据及流量管理。实际上，Nacos 不仅支持配置管理，它还支持服务发现（作为注册中心），...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"注册框架\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-01-25T16:36:00.000Z\\",\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://wbw.edtechhub.com.cn/work-blog-website/5.%E5%BC%80%E5%8F%91%E6%96%B9%E5%90%91/or433c5h/"}],["meta",{"property":"og:site_name","content":"缡墨"}],["meta",{"property":"og:title","content":"注册框架"}],["meta",{"property":"og:description","content":"1.全面概述 Nacos 是 Dynamic Naming and Configuration Service 的首字母简称，一个更易于构建云原生应用的动态服务发现、配置管理和服务管理平台。它提供了一组简单易用的特性集，帮助我们快速实现动态服务发现、服务配置、服务元数据及流量管理。实际上，Nacos 不仅支持配置管理，它还支持服务发现（作为注册中心），..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-01-25T16:36:00.000Z"}],["meta",{"property":"article:modified_time","content":"2026-01-25T16:36:00.000Z"}]]},"readingTime":{"minutes":57.58,"words":17275},"git":{"createdTime":1769358960000,"updatedTime":1769358960000,"contributors":[{"name":"limou3434","username":"limou3434","email":"898738804@qq.com","commits":2,"avatar":"https://avatars.githubusercontent.com/limou3434?v=4","url":"https://github.com/limou3434"}],"changelog":[{"hash":"dca0ee6f6d4b6bf12641e79c41ef6b0f14e62dbd","time":1769358960000,"email":"898738804@qq.com","author":"limou3434","message":"修改 Github 工作流的配置，以方便未来支持前后端拓展"},{"hash":"403d4bb1a423fafb3f1de0fb7b0ef8203abf65fa","time":1769358960000,"email":"898738804@qq.com","author":"limou3434","message":"修改 Github 工作流的配置，以方便未来支持前后端拓展"}]},"autoDesc":true,"filePathRelative":"5.开发方向/1.后端开发/009_2025_12_29_ljp_注册框架.md","headers":[],"bulletin":true}');export{r as comp,c as data};
