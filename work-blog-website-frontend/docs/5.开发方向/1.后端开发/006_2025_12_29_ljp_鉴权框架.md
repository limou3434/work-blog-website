---
createTime: 2025/12/29 21:38:44
permalink: /5.开发方向/21irjv5m/
---
# 鉴权框架
...
可以根据路由进行鉴权，可以 [查阅官方文档](https://sa-token.cc/doc.html#/use/route-check)，不过我的项目还不够大型，而且这个挺好配置的，您看着配置就可以，实现一个类的问题而已。
...
[参考官方文档](https://sa-token.cc/doc.html#/up/login-parameter?id=%e7%99%bb%e5%bd%95%e5%8f%82%e6%95%b0)。
...
![image-20260101230555749](./assets/image-20260101230555749.png)